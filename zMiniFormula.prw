...
//		@ (nJanAltu/2)-24, nJanMeio - (nTamBtn/2) BUTTON oBtnExec PROMPT "Exec.s/utar" SIZE nTamBtn, 018 OF oDlgForm ACTION(fExecuta()) PIXEL
		@ (nJanAltu/2)-24, nJanMeio - (nTamBtn + 2) BUTTON oBtnExec PROMPT "Executar" SIZE nTamBtn, 018 OF oDlgForm ACTION(fExecuta()) PIXEL
		@ (nJanAltu/2)-24, nJanMeio + 2 BUTTON oBtnExec PROMPT "Exec.s/Prot" SIZE nTamBtn, 018 OF oDlgForm ACTION(fExecuta(.F.)) PIXEL
...
Static Function fExecuta(lProtec)
Local aArea    := GetArea()
